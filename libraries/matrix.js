...
/*
 * My edited code of this library :D
 * What I did was basically to make it so the Matrix wouldn't reset the transformation every time I wanted to use it to get the inverse.
 * Github link: https://github.com/leeoniya/transformation-matrix-js/
*/
 ...
 *
 * @param {CanvasRenderingContext2D} [context] - Optional context to (NOT! :D) sync with Matrix
...
function Matrix(context) {
    if (!context) {
        ...
        // https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/getTransform, https://www.printfriendly.com/p/g/8fEMFs
        // https://stackoverflow.com/questions/10892267/html5-canvas-transformation-algorithm-finding-object-coordinates-after-applyin
        let prevTransform = context.getTransform();
        this.a = prevTransform.a;
        this.b = prevTransform.b;
        this.c = prevTransform.c;
        this.d = prevTransform.d;
        this.e = prevTransform.e; // dx
        this.f = prevTransform.f; // dy
        this.context = null; // haha no we don't like setting the context >:D
    }
}
